...
const items=[['Tableau de bord','/admin'],['Formations','/admin/formations'],['Utilisateurs','/admin/utilisateurs'],['Inscriptions','/admin/inscriptions'],['Paiements','/admin/paiements']] as const;
